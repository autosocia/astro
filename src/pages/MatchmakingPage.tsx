...
import { Heart, Users, Star, TrendingUp, Calendar, MapPin, Clock } from 'lucide-react';
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-violet-100">
            <div className="text-center">
              <div className="flex items-center justify-center space-x-4 mb-4">
                ...
                <div className="text-4xl font-display font-bold text-cosmic">
              ...
              <div className="bg-gradient-cosmic-light rounded-xl p-8">
            ...
            <div>
              ...
              <div className="mt-8 flex justify-end">
                <button
                  ...
                  className="bg-gradient-cosmic text-white px-8 py-3 rounded-lg font-semibold hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Next Step
                </button>
              </div>
